package de.rwth.swc.piggybank.goalservice.util
...
object RabbitMQTestUtils {
    // Use the TEST_QUEUE_NAME constant from RabbitMQTestConfig
     ...
     * 
     * @param rabbitTemplate The RabbitTemplate to use for receiving messages
     * @param eventType The expected event type (e.g., "GOAL_UPDATED")
     * @param timeout The maximum time to wait for the message
     * @param timeUnit The time unit of the timeout
